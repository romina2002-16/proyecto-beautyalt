<?php
$conn = new mysqli("beautyalt-db", "root", "BeautyRoot123!", "beautyalt");
...
$sql = "SELECT s.*, u.nombre AS profesional, u.ubicacion, u.foto_perfil
        FROM servicios AS s
  ...
  <div class="tarjetas">
    <?php while($row = $resultado->fetch_assoc()): ?>
      <div class="tarjeta">
        ...
        <div class="profesional">Con <?= htmlspecialchars($row['profesional']) ?> | $<?= number_format($row['precio'], 0) ?></div>
