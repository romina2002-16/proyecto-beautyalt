...
<body>
  ...
  <div class="formulario">
    ...
    <form id="formEditar">
      ...
      <input type="text" name="nombre_cliente" value="<?= $cita['nombre_cliente'] ?>" required>
      <input type="email" name="correo_cliente" value="<?= $cita['correo_cliente'] ?>" required>
      <input type="tel" name="telefono_cliente" value="<?= $cita['telefono_cliente'] ?>">
      <input type="text" name="direccion_cliente" value="<?= $cita['direccion_cliente'] ?>">
      <textarea name="referencia"><?= $cita['referencia'] ?></textarea>
